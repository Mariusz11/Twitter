<?php
    ...
    if(isset($_POST['sendTweet'])){
        ...
        $newTweet = new Tweets();
        $newTweet->setDate(date('Y-m-d G-i-s'));
        $newTweet->setTweet($_POST['tweet']);
        $newTweet->setEmail($nick);
    ...
    <body>
        ...
        <form method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-sm-10">
                    <textarea name="tweet" class="control-label col-sm-10" rows="5"placeholder="Napisz tweet'a"></textarea>
                </div>
            </div>
            
            <div class="form-group">
                <div class="col-sm-2">
                    <input type="submit" name="sendTweet" class="btn btn-default" value="Wyślij">
                </div>
            </div>
...
<?php
    $search = new Tweets();
    $search->loadAllTweets($connection);
?>
       </div> 
    </body>
</html>
